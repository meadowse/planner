...
// Импорт стилей
import './subtask_group_popup.css';
...
export default function SubtaskGroupPopup(props) {
    ...
    return (
        ...
        >
            <div className="popup__content-sub-task-group popup-content">
                <ul className="popup__content-sub-task-group-left">
                    <Responsible additClass={'responsible'} />
                    <TitleService additClass={'title_service'} />
                    <Deadlines additClass={'deadlines'} />
                </ul>
                <div className="popup__content-sub-task-group-right">
                    <Comment />
                </div>
            </div>
        </InputDataPopup>
